...
export const metadata = {
  title: 'Συγκρίνετε Ασφάλειες & Εξοικονομήστε | Sygrineto',
    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl font-black leading-tight">
                ...
                <br />
                <span className="text-amber-400">Απλά!</span>
              </h1>

              <p className="text-xl text-slate-300 max-w-lg">
                Συγκρίνετε τιμές από πάνω από 100 ασφαλιστικούς παρόχους και βρείτε την καλύτερη προσφορά. 
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Προσφορά Ασφάλειας Αυτοκινήτου
              ...
              <div className="flex flex-wrap gap-8 pt-8 border-t border-white/10">
                <div>
                  ...
                  <p className="text-sm text-slate-400">Πάροχοι ασφάλισης</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-white">€279</p>
                  <p className="text-sm text-slate-400">Μέση εξοικονόμηση</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-white">4.8★</p>
                  <p className="text-sm text-slate-400">Βαθμολογία</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="relative">
                {/* Mascot */}
                <div className="absolute -top-8 -right-8 w-48 h-48 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-2xl z-10">
                ...
                <div className="space-y-4 animate-float">
                  <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm ml-auto">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold">Ε</div>
                      <div>
                        <p className="font-bold text-slate-800">Εθνική</p>
                        <div className="flex">
                          {[1,2,3,4,5].map((i) => (
                    ...
                    <p className="text-2xl font-black text-slate-800">€324,00<span className="text-sm font-normal text-slate-500">/έτος</span></p>
                  </div>
                  
                  <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl p-5 max-w-xs">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-10 h-10 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">IA</div>
                      <div>
                        <p className="font-bold text-slate-800 text-sm">Interamerican</p>
                        <div className="flex">
                          {[1,2,3,4,5].map((i) => (
                    ...
                    <p className="text-xl font-black text-slate-800">€298,50<span className="text-xs font-normal text-slate-500">/έτος</span></p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Τι θέλετε να συγκρίνετε;</h2>
            <p className="text-lg text-slate-500">Επιλέξτε από τις υπηρεσίες σύγκρισής μας</p>
          </div>
            ...
            {INSURANCE_VERTICALS.map((vertical) => (
              ...
              >
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  <span className="text-sm font-medium text-teal-600">Συγκρίνετε τώρα</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Πώς λειτουργεί</h2>
            <p className="text-lg text-slate-500">Λάβετε προσφορά σε 3 απλά βήματα</p>
          </div>
            ...
            {[
              {
                step: 1,
                icon: Users,
                title: 'Πείτε μας για εσάς',
                description: 'Συμπληρώστε τα στοιχεία σας στη γρήγορη φόρμα μας. Χρειάζονται μόνο λίγα λεπτά.',
              },
              {
                step: 2,
                icon: Zap,
                title: 'Εμείς συγκρίνουμε',
                description: 'Ψάχνουμε σε πάνω από 100 παρόχους για να βρούμε τις καλύτερες προσφορές.',
              },
              {
                step: 3,
                icon: Award,
                title: 'Επιλέξτε ασφάλεια',
                description: 'Διαλέξτε την κάλυψη που σας ταιριάζει και ολοκληρώστε την αγορά.',
              },
            ].map((item) => (
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 to-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: Shield, label: 'Εποπτευόμενη', value: '100%' },
              { icon: Users, label: 'Ικανοποιημένοι Πελάτες', value: '10Μ+' },
              { icon: Star, label: 'Βαθμολογία', value: '4.8/5' },
              { icon: CheckCircle, label: 'Προσφορές', value: '50Μ+' },
            ].map((stat) => (
              <div key={stat.label}>
      ...
      <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl font-bold mb-4">Έτοιμοι να εξοικονομήσετε;</h2>
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Γίνετε μέλος σε πάνω από 10 εκατομμύρια πελάτες που βρήκαν καλύτερες προσφορές με τη Sygrineto. Ξεκινήστε σήμερα!
          </p>
          <Link
            href="/quote/car"
